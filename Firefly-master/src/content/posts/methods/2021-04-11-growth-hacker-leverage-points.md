...
![](/assets/library/methods/growth-hacker-leverage-points/img-01.png)
...
分群最容易出现的问题，是为了追求“精细化”不断增加维度。理论上，渠道、地区、设备、活跃度、购买频次和用户属性可以组合出大量群体，但**分群本身并不创造价值**。只有当新的切分能够解释原来混在一起的差异，或者能够产生不同的后续判断，继续细分才有意义。否则，用户群越切越小，样本稳定性下降，分析反而更难用。
...
![](/assets/library/methods/growth-hacker-leverage-points/img-02.png)
...
![](/assets/library/methods/growth-hacker-leverage-points/img-03.png)
